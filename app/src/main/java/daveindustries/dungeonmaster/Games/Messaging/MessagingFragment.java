 ...
 */
public class MessagingFragment extends Fragment implements DatabaseAccess.MessageListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            DatabaseAccess.setMessageListener(this);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DatabaseAccess.getMessages(this);
        //DatabaseAccess.setMessageListener(this);

        etSendTo = (EditText) view.findViewById(R.id.etSendTo);
        etMessageToSend = (EditText) view.findViewById(R.id.etMessageToSend);
        btSend = (Button) view.findViewById(R.id.btSend);
        tvReceivedMessage = (TextView) view.findViewById(R.id.tvReceivedMessage);
        btSend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatabaseAccess.SendMessage(new ChatMessage(etSendTo.getText().toString(), etMessageToSend.getText().toString()));
            }
        });
